    ...
    <div class="card-body">
        ...
        ?>
            <table class="table table-striped">
                ...
                <tbody>
                    <?php
                    $ambildatajob = mysqli_query($koneksi, "SELECT id_jobdesk, karyawan.id_karyawan,karyawan.Nama_lengkap, kategori_job, project_name, deadline, status FROM jobdesk INNER JOIN karyawan ON jobdesk.id_karyawan=karyawan.id_karyawan");
                    $i = 1;
                    ...
                    ?>
                        <tr>
                            <td><?= $i++; ?></td>
                            <td><a style="text-decoration: underline; color: black;" href="data_jobdesk_karyawan.php?id_karyawan=<?= $id_karyawan ?>&nama_karyawan=<?= $nama_karyawan ?>"><?= $nama_karyawan; ?></a> </td>
                            <td><?= $kategori_job; ?></td>
                            <td><?= $project_name; ?></td>
                            <td><?= $deadline; ?></td>
                            <td><?= $status; ?>%</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <?php } ?>
                <br>
                <input type="text" name="kategori_job" placeholder="Kategori Job" class="form-control" autocomplete="off" required>
                <br>
                <input type="text" name="project_name" placeholder="Nama Project" class="form-control" autocomplete="off" required>
                <br>
                <label>Deadline</label>
